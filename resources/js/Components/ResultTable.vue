...
<template>
    <div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="lg:w-2/3 w-full mx-auto overflow-auto mt-4">
    ...
    <div v-if="data.type === 'decile'" class="lg:w-2/3 w-full mx-auto overflow-auto mt-4">
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
                <tr>
    ...
    <div v-if="data.type === 'rfm'" class="lg:w-2/3 w-full mx-auto overflow-auto mt-4">
